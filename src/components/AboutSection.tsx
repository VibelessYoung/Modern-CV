...
export function AboutSection() {
  return (
    ...
    >
      <div
        className="absolute inset-x-0 bottom-0 pointer-events-none h-1/3 bg-gradient-to-t from-primary/80 dark:from-blue-400/15 via-blue-300/10 dark:via-blue-500/5 to-transparent"
      />
