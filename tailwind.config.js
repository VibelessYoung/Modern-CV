module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "gradient-1":
          "linear-gradient(135deg, hsl(220, 95%, 62%) 0%, hsl(280, 85%, 65%) 100%)",
        "gradient-2":
          "linear-gradient(180deg, hsl(220, 95%, 62%) 0%, hsl(220, 95%, 52%) 100%)",
        "button-border-gradient":
          "linear-gradient(90deg, hsl(220, 95%, 62%) 0%, hsl(280, 85%, 65%) 100%)",
      },
    },
  },
  plugins: [],
